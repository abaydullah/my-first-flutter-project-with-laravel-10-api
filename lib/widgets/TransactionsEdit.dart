...
class _TransactionEditState extends State<TransactionEdit> {
  ...
  void initState() {
    ...
    transactionCategoryController.text = widget.transaction.category_id.toString();
    transactionDescriptionController.text = widget.transaction.description.toString();
    transactionDateController.text = widget.transaction.transaction_date.toString();
    super.initState();
  }
  ...
  Future saveTransaction(context) async {
    ...
    widget.transaction.category_id = int.parse(transactionCategoryController.text);
    widget.transaction.description = transactionDescriptionController.text;
    widget.transaction.transaction_date = transactionDateController.text;
